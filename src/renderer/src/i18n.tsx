...
const zh = {
  ...
  'tab.search': '搜索',
  'tab.shimo': '石墨文档',
  'shimo.loading': '正在加载石墨文档…',
  'shimo.guideTitle': '还没有配置石墨文档',
  'shimo.guideText': '应用以「内嵌网页」的方式接入石墨文档：在设置里填上你要管理的那张表格链接，打开「石墨文档」标签就会在应用内加载它，登录一次即可长期使用（登录态只保存在本机）。',
  'shimo.guideInvalidUrl': '已保存的链接不是一个有效的石墨文档地址，请在设置中重新填写。',
  'shimo.openSettings': '去设置',
  'shimo.back': '后退',
  'shimo.forward': '前进',
  'shimo.refresh': '刷新',
  'shimo.home': '石墨工作台',
  'shimo.address': '地址栏',
  'shimo.addressInvalid': '只能输入石墨文档（shimo.im）的链接',
  'shimo.openExternal': '在系统浏览器中打开',
  'shimo.logout': '退出登录',
  'shimo.logoutConfirm': '将清除本机保存的石墨文档登录状态（Cookie 与本地存储），下次需要重新登录。确定退出登录吗？',
  'shimo.loadFailed': '石墨文档页面加载失败，请检查网络后重试。',
  'shimo.retry': '重试',
  ...
  'nav.login': '特殊渠道（扫码登录）',
  'nav.shimo': '石墨文档',
  'nav.shimoDesc': '石墨文档个人版没有开放 API，应用以「内嵌网页」的方式接入：把表格链接填在下面，「石墨文档」标签页会在应用内打开它，可以像在浏览器里一样登录和管理你的文档。',
  'nav.shimoUrl': '表格链接',
  'nav.shimoUrlHint': '在浏览器里打开那张石墨表格，复制地址栏链接粘贴到这里（形如 https://shimo.im/sheets/…）。留空则「石墨文档」标签页只显示配置引导。',
  'nav.shimoLoginHint': '登录态只保存在本机（独立分区，与搜索用的闲鱼/淘宝登录互不影响），重启应用后仍有效；在「石墨文档」标签页点「退出登录」可清除。内嵌网页只允许访问石墨域名，页面里的站外链接会自动转到系统浏览器打开。',
  'nav.shimoInvalidUrl': '石墨文档链接无效：只能保存 shimo.im 的 https 链接',
  'nav.backup': '备份与恢复',
  'nav.about': '关于与更新',
  ...
  'settings.publishAdd': '新增发布目标',
  'settings.publishNewTitle': '新增发布目标',
  'settings.publishEditTitle': '编辑发布目标',
  'settings.publishPlatform': '平台',
  'settings.publishName': '名称',
  'settings.publishNamePlaceholder': '例如：我的 Discogs 店铺',
  // The account is never typed: the app detects it (闲鱼 after 扫码登录,
  // Discogs after 测试连接) and the main process persists it.
  'settings.publishAccountAutoNote': '账号由应用自动识别，无需手动填写：闲鱼目标在「扫码登录」成功后写入，Discogs 目标在「测试连接」成功后写入。',
  'settings.publishCurrentAccount': '当前账号：',
  'settings.publishAccountDetectXianyu': '扫码登录后自动识别',
  'settings.publishAccountDetectDiscogs': '点「测试连接」自动识别',
  'settings.publishAccountValue': '账号：{account}',
  'settings.publishEnabled': '启用',
  'settings.publishTest': '测试连接',
  'settings.publishTesting': '测试中…',
  'settings.publishEdit': '编辑',
  'settings.publishDelete': '删除',
  'settings.publishDeleteConfirm': '确定删除发布目标「{name}」吗？',
  'settings.publishSaved': '发布目标已保存',
  'settings.publishDeleted': '发布目标已删除',
  'settings.publishSaveFailed': '保存发布目标失败',
  'settings.publishNameRequired': '请填写名称',
  'settings.publishGroupDiscogs': 'Discogs 默认值',
  ...
  'settings.publishStatusChecking': '检查登录状态…',
  'settings.publishStatusUnknown': '状态未知',
  'settings.publishStatusLoggedIn': '已登录',
  'settings.publishStatusLoggedInAccount': '已登录 · {account}',
  'settings.publishStatusLoggedOut': '未登录',
  'settings.publishStatusNotStarted': 'Chrome 未启动',
  'settings.publishLoginScan': '扫码登录',
  'settings.publishLoggingIn': '等待扫码…',
  'settings.publishLogout': '退出登录',
  'settings.publishLoggingOut': '退出中…',
  'settings.publishLoginSuccess': '扫码登录成功',
  'settings.publishLoginSuccessAccount': '扫码登录成功：{account}',
  ...
  'publish.title': '发布预览',
  'publish.targetLabel': '发布目标：{name}',
  'publish.preparing': '正在准备发布预览…',
  'publish.prepareFailed': '准备发布失败：{error}',
  'publish.retry': '重试',
  'publish.cancel': '取消',
  'publish.confirm': '确认发布',
  'publish.close': '关闭',
  'publish.blockers': '无法发布',
  'publish.warnings': '请注意',
  'publish.publishing': '正在发布…',
  'publish.stepProgress': '第 {step}/{total} 步',
  'publish.awaitingUser': '已自动填好，请在自动前置的 Chrome 窗口中确认并点击「发布」完成最后一步',
  'publish.cancelling': '正在取消…',
  'publish.cancelRun': '取消发布',
  'publish.resultSuccess': '发布成功',
  'publish.resultError': '发布失败',
  'publish.resultCancelled': '已取消发布',
  'publish.openListing': '打开商品页',
  'publish.shimoReminder': '请把这条发布记录更新到「石墨文档」。',
  'publish.shimoOpen': '去石墨文档',
  'publish.artifacts': '已保存以下排查文件（截图 / 页面 HTML），可用于定位失败原因：',
  'publish.unknownError': '未知错误',

  // Publish preview fields (keys are emitted verbatim by the main process)
  'publish.field.catalogNumber': '目录号',
  'publish.field.title': '标题',
  'publish.field.description': '描述',
  'publish.field.price': '价格',
  'publish.field.currency': '币种',
  'publish.field.release': 'Discogs Release',
  'publish.field.condition': '唱片成色',
  'publish.field.sleeveCondition': '封套成色',
  'publish.field.status': '发布状态',
  'publish.field.allowOffers': '允许议价',
  'publish.field.comments': '卖家备注',
  'publish.field.externalId': '外部编号',
  'publish.field.location': '货位',
  'publish.field.weight': '重量 (g)',
  'publish.field.formatQuantity': 'Counts As',
  'publish.field.image': '封面图',
  'publish.field.xianyuCondition': '成色',

  // Publish preview field hints
  'publish.hint.weight': 'Discogs 运费计算使用的重量，单位克；留空则使用店铺默认值。',
  'publish.hint.formatQuantity': '该条目占用的商品数量上限（Discogs「Counts As」）。',
  'publish.hint.externalId': '你自己的库存编号，用于和本地记录对应。',
  'publish.hint.image': '封面图由应用自动获取，仅作预览，不可编辑。'
}
